...
@section('content')
    ...
    <div class="relative bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
        ...
        <div class="p-1 mx-auto max-w-7xl lg:p-1">
            <div class="flex">
            ...
            <div class="mt-5">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <livewire:import-employees />
                <livewire:export-employees-pdf />
                </div>
            </div>
            @endauth
